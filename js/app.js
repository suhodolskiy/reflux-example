...
},{"reflux":157}],178:[function(require,module,exports){
...
var Form = React.createClass({displayName: "Form",
	...
	render: function() {
		return (
			React.createElement("div", {className: "app-todo__form"}, 
				React.createElement("div", {className: "container"}, 
					React.createElement("form", {onSubmit: this.handleAddTask}, 
						React.createElement("input", {className: "form__input", 
							   type: "text", 
							   ref: "task", 
...
},{"../actions/app-actions.js":177,"react":156}],179:[function(require,module,exports){
var React = require('react'),
	Actions = require('../actions/app-actions.js');
...
var Task = React.createClass({displayName: "Task",
	...
	render: function() {
		return (
			React.createElement("li", {className: 'list__task list__task--'+this.props.task.done}, 
				this.props.task.value, 
				React.createElement("a", {className: "task__check", onClick: this.handlerCheckTask}), 
				React.createElement("a", {className: "task__remove", onClick: this.handlerRemoveTask})
			)
		);
	}
});
...
},{"../actions/app-actions.js":177,"react":156}],180:[function(require,module,exports){
var React = require('react'),
...
var Tasks = React.createClass({displayName: "Tasks",
	...
	render: function(){
		...
		var tasks = this.state.tasks.map(function(task, i){ return React.createElement(Task, {key: i, id: i, task: task})});

		// Translate in line store and display
		var strTasks = JSON.stringify(this.state.tasks);

		return (
			React.createElement("section", {className: "app-todo__tasks tasks"}, 
				React.createElement("h2", {className: "tasks__title"}, 
					"Tasks", 
					React.createElement("small", null, 
						' — '+this.getCompletedLength()+' / '+this.state.tasks.length+' ('+this.calculatePercent()+'%)'
					)
				), 
				React.createElement("ul", {className: "tasks__list"}, 
					tasks
				), 
				React.createElement("div", {className: "tasks__json-store"}, 
					strTasks
				)
			)
		);
...
},{"../store/app-store.js":182,"./app-task.js":179,"react":156,"reflux":157}],181:[function(require,module,exports){
var React = require('react'),
...
var App = React.createClass({displayName: "App", 
		render: function(){
			return (
				React.createElement("div", {className: "app-todo"}, 
...
},{"./components/app-form.js":178,"./components/app-tasks.js":180,"react":156}],182:[function(require,module,exports){
var React = require('react'),
	Reflux = require('reflux'),
	Actions = require('../actions/app-actions.js');
...
},{"../actions/app-actions.js":177,"react":156,"reflux":157}]},{},[181])